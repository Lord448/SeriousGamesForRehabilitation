...
public class Background {
    ...
    public void render(float deltaTime, final SpriteBatch batch){
        ...
        for(int layer=0; layer<backgroundOffsets.length; layer++){
            ...
            /*SKY*/
            batch.draw(staticBackgrounds[0],0, 0, GameHandler.WORLD_WIDTH*5, WORLD_HEIGHT*7);
            /*NUBES*/
            ...
            batch.draw(currentOceanFrame, -4, 0, GameHandler.WORLD_WIDTH*5 + 4, (float)(WORLD_HEIGHT*2.8));
            /*FRANJA - EVITA DEFECTO DE FRAMES EN OCEANO*/
            batch.draw(staticBackgrounds[1],0, 198, GameHandler.WORLD_WIDTH*5, WORLD_HEIGHT/3);
            /*ROCA 2 - DERECHA*/
