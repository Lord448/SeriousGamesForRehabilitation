...
public class Climb {
    ...
    public Climb(int x, int y){
        ...
        /*Cargar la img*/
        image = new Texture(Gdx.files.internal("wizard.png"));
    ...
    public void render(final SpriteBatch batch) {
        ...
        if(spelling == true) {
            ...
            batch.draw(currentSpelling_Frame, x, y, 80, 80);
            if (spellingTime >= 1.1f) {
                spelling = false;
                spellingTime = 0;
            }
        }
        if(spelling == false){
            ...
            batch.draw(currentIdle_Frame, x, y, 50, 50);
        }
    }
    private void spellingMovement(TextureRegion [][] temporal){
        ...
        spellingAnimation=new Animation<>(1/7f, spellingMovement);
    }
    private void idleMovement(TextureRegion [][] temporal){
        ...
        idleAnimation = new Animation<>(1/7f, idleMovement);
    }
}
